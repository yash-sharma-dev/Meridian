...
- A PRO user can add WorldMonitor as an MCP server in Claude Desktop using only their API key and `https://api.meridian.app/mcp` as the URL — no install, no CLI.
