...
Meridian runs five thematic variants from a single codebase, each tailored to a different audience:
...
- **API access** for developers and organizations to integrate Meridian data into their own tools
...
A: The web interface can be referenced and linked in reporting. For data integration, an API tier is planned. Please attribute "Meridian (meridian.app)" when referencing the platform in published work.
...
- **GitHub**: github.com/yash-sharma-dev/Meridian
