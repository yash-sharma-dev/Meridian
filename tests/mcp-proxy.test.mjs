...
function makeGetRequest(params = {}, origin = 'https://meridian.app') {
...
function makePostRequest(body = {}, origin = 'https://meridian.app') {
...
describe('api/mcp-proxy', () => {
  ...
  describe('GET /api/mcp-proxy (list tools)', () => {
    ...
    it('ignores invalid JSON in headers param', async () => {
      ...
      const req = new Request(url.toString(), { method: 'GET', headers: { origin: 'https://meridian.app' } });
