...
<body><a href="https://www.meridian.app" class="wm-logo" target="_blank" rel="noopener">${GLOBE_SVG}<span class="wm-logo-text">WorldMonitor MCP</span></a>
...
<body>
<a href="https://www.meridian.app" class="wm-logo" target="_blank" rel="noopener">${GLOBE_SVG}<span class="wm-logo-text">WorldMonitor MCP</span></a>
<div class="card">
<div class="client-hd">
...
<hr>
<form id="cf" method="POST" action="https://api.meridian.app/oauth/authorize">
...
export default async function handler(req) {
  ...
  if (method === 'POST') {
    ...
    if (origin && origin !== 'https://api.meridian.app' && origin !== 'null') {
