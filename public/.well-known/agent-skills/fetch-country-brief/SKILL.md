...
```
GET https://api.meridian.app/api/intelligence/v1/get-country-intel-brief
```
...
curl -s -H "X-WorldMonitor-Key: $WM_API_KEY" \
  'https://api.meridian.app/api/intelligence/v1/get-country-intel-brief?country_code=IR' \
  | jq -r '.brief'
```
...
curl -s --get -H "X-WorldMonitor-Key: $WM_API_KEY" \
  'https://api.meridian.app/api/intelligence/v1/get-country-intel-brief' \
