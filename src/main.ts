...
// failures from our self-hosted R2 PMTiles bucket or any api.meridian.app
...
Sentry.init({
  ...
  beforeSend(event) {
    ...
    // leaves first-party fetch failures (self-hosted R2 PMTiles bucket, api.meridian.app)
...
// In web production, route RPC calls through api.meridian.app (Cloudflare edge).
